...
class CwxMqPoco:
    ...
    def pack_mq(self, task_id, data, topic, zip=False):
        '''
        @brief 形成mq的一个消息包
        ...
        self.header.msg_type = CwxMqPoco.MSG_TYPE_RECV_DATA
    ...
    def pack_sync_report(self, task_id, sid=None, chunk=0, topic=None, source=None, zip=False):
        '''
        ...
        self.header.msg_type = CwxMqPoco.MSG_TYPE_SYNC_OUTER_REPORT
        self.header.task_id = task_id
    ...
    def pack_sync_data_reply(self, task_id, seq):
        '''
        ...
        self.header.task_id = task_id
        self.header.data_len = 8
        return str(self.header) + seq
